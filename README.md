...
- [x] **PPT/Pitch deck link** — [View Pitch Deck](https://docs.google.com/presentation/d/1LjaQ8QESJDueii0HhhTMBedldOsYPYmZ/edit?usp=sharing)
- [x] **Demo video link** — [Watch Demo](https://drive.google.com/file/d/1j7Bb9Xl6utuD5apVSX46RbOmpllrNGvR/view?usp=sharing)
...
- [x] **Google Sheet response export** — [open native Google Sheet](https://docs.google.com/spreadsheets/d/1KKx-CSydnk6ZtFr5XCSin4qodCX63jJjAFMGS7hLHwY/edit?usp=drivesdk)

### Feedback survey

Have you tried Ipon? [**Share your feedback**](https://docs.google.com/forms/d/e/1FAIpQLSdrAmM5ooICU01rq4SKqzDTbzPEgu0rJPehSoboKTmtKaKvbw/viewform) — a 2-minute public survey. Responses are collected in the feedback sheet linked above.
...
```
https://docs.google.com/spreadsheets/d/1KKx-CSydnk6ZtFr5XCSin4qodCX63jJjAFMGS7hLHwY/edit?usp=drivesdk    # native Google Sheet response export
```
...
| Google Sheet response export | https://docs.google.com/spreadsheets/d/1KKx-CSydnk6ZtFr5XCSin4qodCX63jJjAFMGS7hLHwY/edit?usp=drivesdk |
...
| [`docs/user-feedback-log.md`](docs/user-feedback-log.md) | 60-user feedback log with date column |
| [`docs/level5-feedback-iteration-summary.md`](docs/level5-feedback-iteration-summary.md) | Feedback-to-iteration map |
| Google Sheet response export | https://docs.google.com/spreadsheets/d/182j7eK68Gc5-Xx8unzsrXXhT30-OAc11bhA0Z3lXWMA/edit?usp=drivesdk |
...
| Source | Rows | Count | Last verified |
|---|---|---|---|
| [Google Sheet response export](https://docs.google.com/spreadsheets/d/182j7eK68Gc5-Xx8unzsrXXhT30-OAc11bhA0Z3lXWMA/edit?usp=drivesdk) | responses | 60 | 2026-06-30 |
| Local feedback log | entries | 60 | 2026-06-30 |
